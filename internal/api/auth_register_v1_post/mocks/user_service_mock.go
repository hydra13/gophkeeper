...
// UserServiceMock implements mm_auth_register_v1_post.UserService
...
// NewUserServiceMock returns a mock for mm_auth_register_v1_post.UserService
...
func (mmRegister *mUserServiceMockRegister) Expect(ctx context.Context, email string, password string) *mUserServiceMockRegister {
	...
	mmRegister.defaultExpectation.params = &UserServiceMockRegisterParams{ctx, email, password}
...
// ExpectEmailParam2 sets up expected param email for UserService.Register
func (mmRegister *mUserServiceMockRegister) ExpectEmailParam2(email string) *mUserServiceMockRegister {
	if mmRegister.mock.funcRegister != nil {
		mmRegister.mock.t.Fatalf("UserServiceMock.Register mock is already set by Set")
	}
...
func (mmRegister *mUserServiceMockRegister) Inspect(f func(ctx context.Context, email string, password string)) *mUserServiceMockRegister {
...
func (mmRegister *mUserServiceMockRegister) Set(f func(ctx context.Context, email string, password string) (i1 int64, err error)) *UserServiceMock {
	if mmRegister.defaultExpectation != nil {
...
// Then helper
func (mmRegister *mUserServiceMockRegister) When(ctx context.Context, email string, password string) *UserServiceMockRegisterExpectation {
	if mmRegister.mock.funcRegister != nil {
		mmRegister.mock.t.Fatalf("UserServiceMock.Register mock is already set by Set")
	}
	...
	expectation := &UserServiceMockRegisterExpectation{
		...
		params:             &UserServiceMockRegisterParams{ctx, email, password},
...
// Register implements mm_auth_register_v1_post.UserService
func (mmRegister *UserServiceMock) Register(ctx context.Context, email string, password string) (i1 int64, err error) {
	...
	mm_params := UserServiceMockRegisterParams{ctx, email, password}
	...
	if mmRegister.RegisterMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockRegisterParams{ctx, email, password}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.email != nil && !minimock.Equal(*mm_want_ptrs.email, mm_got.email) {
				mmRegister.t.Errorf("UserServiceMock.Register got unexpected parameter email, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmRegister.t.Fatalf("Unexpected call to UserServiceMock.Register. %v %v %v", ctx, email, password)
	return
}
