...
func (r *Runner) PrintUsage() {
	...
	fmt.Fprintln(r.deps.Stderr, "  get      <id> [output-path]        Get record by ID (binary: save to output-path)")
	...
	fmt.Fprintln(r.deps.Stderr, "  update   <id> <name> [data]        Update existing record")
	fmt.Fprintln(r.deps.Stderr, "                                    binary: data=file-path")
	fmt.Fprintln(r.deps.Stderr, "                                    --metadata <text>  set metadata")
	fmt.Fprintln(r.deps.Stderr, "                                    --metadata \"\"      clear metadata")
	fmt.Fprintln(r.deps.Stderr, "  delete   <id>                      Delete record")
