...
type FormValues = Omit<RecordUpsertInput, "file"> & { fileName: string };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item name="keyVersion" hidden>
          <Input type="hidden" />
        </Form.Item>

        <Form.Item name="payloadVersion" hidden>
          <Input type="hidden" />
        </Form.Item>
        ...
        {recordType === "binary" ? (
          <>
            <Form.Item
              label={mode === "create" ? "File" : "New file"}
              name="fileName"
              rules={
                mode === "create"
            ...
            <Typography.Paragraph type="secondary" style={{ marginTop: -8 }}>
              {mode === "create"
                ...
                : "Leave the file empty to keep the current binary content."}
